...
export function getAltPaths(): Record<string, string> {
  const paths: Record<string, string> = {
    ...
    '/notes': '/notes',
    '/blog': '/blog',
    '/blog/when-a-self-parking-car-cannot-trust-its-imagination': '/blog/when-a-self-parking-car-cannot-trust-its-imagination',
...
export function getPageTitles(): Record<string, string> {
  const titles: Record<string, string> = {
    ...
    '/blog': 'Blog',
    '/privacy': 'Privacy',
    '/blog/when-a-self-parking-car-cannot-trust-its-imagination': 'Teaching a Car to Park by Imagining the Future, and Learning When Not to Trust It',
