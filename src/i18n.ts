  ...
  en: {
    ...
    experience: {
      ...
      santifer: {
        ...
        jacobo: {
          title: 'Voice AI Platform (STT/TTS + Agent)',
          badge: 'Voice Agent Infrastructure',
          desc: 'Built and maintained a voice-agent layer in a legacy AI receptionist system, including speech-to-text, text-to-speech, and conversation orchestration in production.',
          items: [
            { icon: 'network', text: 'Integrated STT and TTS services into legacy receptionist workflows' },
            { icon: 'calendar', text: 'Maintained production voice flows with robust fallback handling' },
            { icon: 'percent', text: 'Improved conversation continuity across voice turns and handoffs' },
            { icon: 'package', text: 'Delivered end-to-end voice features from implementation to rollout' },
            { icon: 'userCheck', text: 'Collaborated with product and engineering teams in remote setup' },
          ],
          soldWith: '',
          caseStudyUrl: '',
        },
      ...
      items: [
        {
          ...
          date: 'August 27, 2025',
          source: 'LinkedIn',
          url: 'https://www.linkedin.com/in/subash-pandey-ai/details/recommendations/',
          avatar: '/akash.webp',
        },
      ],
    },
